...
if ($func == 'update')
{
  ...
  $REX['ADDON']['be_style']['plugin_customizer']['labelcolor'] = htmlspecialchars(substr(rex_request("customizer-labelcolor","string"),0,20));
            ...
            <fieldset class="rex-form-col-1">
              ...
              <div class="rex-form-row">
              	<p class="rex-form-col-a rex-form-checkbox">
              		...
              		<input class="rex-form-text" type="checkbox" id="rex-form-agk-showlink" name="customizer-showlink" value="1" ';
