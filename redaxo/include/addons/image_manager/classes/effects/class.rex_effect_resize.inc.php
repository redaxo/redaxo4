...
// Todo:
// - Vergroessern erlauben oder nicht. aber eher als Modul einsetzen, also
// fit
...
//--></script>';
	...
	function getParams() {
		...
		return array( array('label' => $I18N -> msg('imanager_effect_resize_width'), 'name' => 'width', 'type' => 'int', ), array('label' => $I18N -> msg('imanager_effect_resize_height'), 'name' => 'height', 'type' => 'int'), array('label' => $I18N -> msg('imanager_effect_resize_style'), 'name' => 'style', 'type' => 'select', 'options' => $this -> options, 'default' => 'fit', 'suffix' => $this -> script), array('label' => $I18N -> msg('imanager_effect_resize_imgtosmall'), 'name' => 'allow_enlarge', 'type' => 'select', 'options' => array('enlarge', 'not_enlarge'), 'default' => 'enlarge', ), );
	}
