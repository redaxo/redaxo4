...
';
  ...
  if(rex_replace_dynamic_contents($config_file, $content) !== false)
    echo rex_info($I18N->msg('config_saved'));
  else
    echo rex_warning($I18N->msg('config_not_saved'));
}

if(!is_writable($config_file))
  echo rex_warning($I18N->msg('config_not_writable', $config_file));

echo '

<div class="rex-addon-output">

<h2 class="rex-hl2">'. $I18N->msg('subpage_config') .'</h2>
      ...
      <div class="rex-form-wrapper">
			...
			<div class="rex-form-row rex-form-element-v2">
				<p class="rex-form-text">
					<label for="max_cachefiles">'. $I18N->msg('max_cache_files') .'</label>
			...
			<div class="rex-form-row rex-form-element-v2">
				<p class="rex-form-text">
					<label for="max_filters">'. $I18N->msg('max_filters') .'</label>
			...
			<div class="rex-form-row rex-form-element-v2">
				<p class="rex-form-text">
					<label for="max_resizekb">'. $I18N->msg('max_resizekb') .'</label>
			...
			<div class="rex-form-row rex-form-element-v2">
				<p class="rex-form-text">
					<label for="max_resizepixel">'. $I18N->msg('max_resizepx') .'</label>
			...
			<div class="rex-form-row rex-form-element-v2">
				<p class="rex-form-text">
					<label for="jpg_quality">'. $I18N->msg('jpg_quality') .' [0-100]</label>
