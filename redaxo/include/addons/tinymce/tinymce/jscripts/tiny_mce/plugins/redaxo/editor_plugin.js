...
// -------------------------------------------------------------------------- //
            ...
            var se = ed.selection;
				...
				ed.windowManager.open({
					...
					width : 400 + parseInt(ed.getLang('redaxoMedia_delta_width', 0)),
					height : 160 + parseInt(ed.getLang('redaxoMedia_delta_height', 0)),
					inline : 1
				}, {
					plugin_url : url, // Plugin absolute URL
					some_custom_arg : 'custom arg' // Custom argument
		...
		getInfo : function() {
			return {
				longname : 'REDAXO plugin',
				author : 'Andreas Eberhard',
				authorurl : 'http://rex.andreaseberhard.de',
				infourl : 'http://rex.andreaseberhard.de',
				version : "1.0"
			};
		}
	});
