...
// -----------------------------------------------------------------------------
	...
	if (isset($REX['REDAXO']) && $REX['REDAXO'])
	{
		...
		{
			if ((($rxa_tinymce['get_page'] == $rxa_tinymce['medienpool']) or ($rxa_tinymce['get_page'] == $rxa_tinymce['linkmap'])) and (($rxa_tinymce['get_tinymce'] == 'true') or ($_SESSION['a52_tinymce'] == 'true')))
			{
