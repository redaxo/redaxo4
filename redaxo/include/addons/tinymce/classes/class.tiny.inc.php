      ...
      $address = $_SERVER['SCRIPT_FILENAME'];
		...
		if ($GLOBALS['TINY2']['script']!=1) {
			if(strstr($_SERVER['HTTP_USER_AGENT'],"MSIE")) {
				echo "\n".'<script language="javascript" type="text/javascript" src="../files/tiny_mce/tiny_mce.js"></script>';
			} else {
				echo "\n".'<script language="javascript" type="text/javascript" src="../files/tiny_mce/tiny_mce_gzip.php"></script>';
			}
