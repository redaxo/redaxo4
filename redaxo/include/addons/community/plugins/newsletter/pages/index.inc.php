...
$nl_filter_profile = rex_request("nl_filter_profile","int",1);
if($nl_filter_profile != 1)
  $nl_filter_profile = 0;
...
<table class="rex-table" cellpadding="5" cellspacing="1">
	...
	<tr>
		<td class="rex-icon"></td>
		<td align="right"><input type="checkbox" name="nl_filter_profile" id="nl_filter_profile" value="1" <?php if($nl_filter_profile == "1") echo 'checked="checked"'; ?> /></td>
		<td><label for="nl_filter_profile">Wenn aktiviert, dann an User mit profile=1 den Newsletter schicken, ansonsten an alle mit profile=0</label></td>
		<td></td>
	</tr>
	...
	<tr>
		...
		<td><label for="nl_filter_status">Wenn aktiviert, dann an User mit status=1 den Newsletter schicken, ansonsten an alle mit status=0</label></td>
		<td></td>
	</tr>
