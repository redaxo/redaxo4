...
// --- DYN
define('REX_COM_PAGE_PROFIL_ID',1);
define('REX_COM_PAGE_MYPROFIL_ID',1);
define('REX_COM_PAGE_REGISTER_ID',1);
define('REX_COM_PAGE_REGISTER_ACCEPT_ID',1);
define('REX_COM_PAGE_PSWFORGOTTEN_ID',1);
define('REX_COM_PAGE_LOGIN_ID',1);
define('REX_COM_PAGE_LOGOUT_ID',1);
define('REX_COM_USERCAT_ID',1);
// --- /DYN
// ----------------- /DONT EDIT BELOW THIS
