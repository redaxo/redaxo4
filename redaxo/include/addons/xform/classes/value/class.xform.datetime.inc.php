...
class rex_xform_datetime extends rex_xform_abstract
{
	...
	function enterObject(&$email_elements,&$sql_elements,&$warning,&$form_output,$send = 0)
	{
		...
		$isodatum = sprintf ("%04d-%02d-%02d %02d:%02d", $year, $month, $day, $hour, $min);
		$datum = $isodatum;

		$email_elements[$this->elements[1]] = "$day.$month.$year $hour.$min";
	...
	{
		return "datetime -> Beispiel: datetime|feldname|Text *|jahrstart|jahrend|[format: Y-m-d h:i]";
	}
}
