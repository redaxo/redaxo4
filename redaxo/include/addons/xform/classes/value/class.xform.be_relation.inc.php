...
class rex_xform_be_relation extends rex_xform_abstract
{
  ...
  { 
    ...
    $relationstype = (int) $this->elements[5];  // single=0;multiple=1
    if($relationstype != 1)
      $relationstype = 0;
    ...
    // ***** MULTIPLE / SELECT
      }elseif($relationstype == 1 && $style == 1)
      {
      ...
      $SEL->addOption("-", "");
        ...
        $SEL->addOption( $v[$table_field], $v["id"]);
            ...
            <div class="rex-widget">
              <div class="rex-widget-media">
                ...
                <p class="rex-widget-icons">
                  <a onclick="em_openRelation('.$this->getId().',\''.$table.'\',\''.$table_field.'\');return false;" class="rex-icon-file-open" href="#"><img width="16" height="16" alt="Medium auswŠhlen" title="Medium auswŠhlen" src="media/file_open.gif"/></a>
                  <a onclick="em_addRelation('.$this->getId().',\''.$table.'\',\''.$table_field.'\');return false;" class="rex-icon-file-add" href="#"><img width="16" height="16" alt="Neues Medium hinzufŸgen" title="Neues Medium hinzufŸgen" src="media/file_add.gif"/></a>
                  <a onclick="em_deleteRelation('.$this->getId().',\''.$table.'\',\''.$table_field.'\');return false;" class="rex-icon-file-delete" href="#"><img width="16" height="16" alt="AusgewŠhltes Medium lšschen" title="AusgewŠhltes Medium lšschen" src="media/file_del.gif"/></a>
                </p>
              </div>
            </div>
          </div>';
  ...
  function getDefinitions()
  {
    return array(
            ...
            'values' => array(
              ...
              array( 'type' => 'select',    'name' => 'Relationtype', 'default' => '', 'definition' => 'single=0;multiple=1' ), // ;multiple=1
