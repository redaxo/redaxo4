	...
	{	
		...
		$form_output[] = '
			<p class="formbe_mediapool formlabel-'.$this->label.'">
				...
				<span><a href="#" onclick="openREXMedia('.$i.',\'\');return false;" tabindex="27"><img src="media/file_open.gif" width="16" height="16" title="Medium auswählen" alt="Medium auswählen" /></a>
				<a href="#" onclick="addREXMedia('.$i.');return false;" tabindex="28"><img src="media/file_add.gif" width="16" height="16" title="Neues Medium hinzufügen" alt="Neues Medium hinzufügen" /></a>
				<a href="#" onclick="deleteREXMedia('.$i.');return false;" tabindex="29"><img src="media/file_del.gif" width="16" height="16" title="Ausgewähltes Medium löschen" alt="Ausgewähltes Medium löschen" /></a>
				</span>
			</p>';
