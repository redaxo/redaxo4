...
if($func == "add" || $func == "edit")
{
	...
	echo $I18N->msg('back_to_overview');
	...
	$field->setLabel($I18N->msg("key"));
	
	$field = &$form->addTextField('mail_from');
	$field->setLabel($I18N->msg("email_from"));
	
	$field = &$form->addTextField('mail_from_name');
	$field->setLabel($I18N->msg("email_from_name"));
	    
	$field = &$form->addTextField('subject');
	$field->setLabel($I18N->msg("subject"));
	
	$field = &$form->addTextareaField('body');
	$field->setLabel($I18N->msg("body"));
...
if($func == "delete")
{
	...
	echo rex_info($I18N->msg('info_template_deleted'));
...
if($func == ""){
  ...
  $list->setColumnLabel('mail_from', $I18N->msg('header_template_mail_from'));
  $list->setColumnLabel('mail_from_name', $I18N->msg('header_template_mail_from_name'));
  $list->setColumnLabel('subject', $I18N->msg('header_template_subject'));

	$list->removeColumn('body','id');

	$list->addColumn($I18N->msg('header_template_functions'), $I18N->msg('delete_template'));
  $list->setColumnParams($I18N->msg('header_template_functions'), array('page'=>$page, 'subpage'=>$subpage, 'func' => 'delete', 'template_id' => '###id###'));
