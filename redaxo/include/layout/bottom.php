...
<!-- *** OUTPUT OF CONTENT - END *** -->
  ...
  <div id="rex-footer">
    <div id="rex-navi-footer">
      ...
      <p id="rex-scripttime"><!--DYN--><?php echo (memory_get_peak_usage(true)/(1024*1024)) ?> MBytes | <?php echo rex_showScriptTime() ?> sec | <?php echo rex_formatter :: format(time(), 'strftime', 'date'); ?><!--/DYN--></p>
    </div>
  </div>
