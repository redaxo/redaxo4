...
function TinyMCE_advanced_getEditorTemplate(settings) {
	...
	var buttonNamesRow1 = tinyMCE.getParam("theme_advanced_buttons1", "separator,justifyleft,justifycenter,justifyright,justifyfull,separator,styleselect,separator,bullist,numlist,undo,redo,link,unlink,cleanup,code,charmap", true, ',');
	...
	/*
	// Render row 2
	var buttonNamesRow2 = tinyMCE.getParam("theme_advanced_buttons2", "separator,outdent,indent,separator,separator,anchor,image,cleanup,help,code", true, ',');
