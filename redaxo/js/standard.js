...
{
	newWindow('rexmediapopup','index.php?page=medienpool&opener_input_field=REX_MEDIA_'+id,300,400,'');
}
...
{
	newWindow('rexmediapopup','index.php?page=medienpool&func=add&opener_input_field=REX_MEDIA_'+id,300,400,'');
}